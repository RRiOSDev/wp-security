...
<?php		exit;
	...
	if ( $interim_login ) {
		...
		elseif ( strpos( $redirect_to, 'about.php?updated' ) )
			$errors->add('updated', __( '<strong>You have successfully updated website!</strong> Please log back in to see what&#8217;s new.' ), 'message' );
	}
...
<form name="loginform" id="loginform" action="<?php echo esc_url( site_url( 'rr-admin.php', 'login_post' ) ); ?>" method="post">
	<p>
		<label for="user_login"><?php _e( 'Username or Email Address' ); ?><br />
